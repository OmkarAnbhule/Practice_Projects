...
const RotatingModel = ({ children, setHovered, hover, ...props }) => {
  ...
  return (
    <group ref={modelRef} onPointerOver={onPointerOver} onPointerOut={onPointerOut} {...props}>
      {children}
    </group>
  );
};

export const GLBModelLoader = ({ modelName, setHovered, hover, ...props }) => {
  const modelMap = {
  ...
  return (
    <RotatingModel modelName={modelName} setHovered={setHovered} hover={hover} {...props}>
      {selectedModel}
    </RotatingModel>
  );
};
